...
public class Ejercicio4 {
    ...
    public static void main(String[] args) {
        EstacionMeteorologica lp;
        EstacionMeteorologica mdp;
        
        RegistroTemperaturaAnual ra;
        RegistroTemperaturaMensual rm;
        
        int añoInicial, cantidadAños;

        // Estación La Plata
        lp = new EstacionMeteorologica("La Plata", -34.921, -57.955);
        añoInicial = 2021;
        cantidadAños = 3;
        ra = new RegistroTemperaturaAnual(añoInicial, cantidadAños, lp);
        ...
        for (int i = 0; i < cantidadAños; i++) {
            for (int j = 1; j <= 12; j++) {
                ra.setTemperatura(
                        j,
                        i,
                        GeneradorAleatorio.generarDouble(45)
                );
            }
        }
        
        System.out.println(ra.toString());
        System.out.println(ra.getTopTemperatura() + "\n");
       
        
        // Estación Mar del Plata
        mdp = new EstacionMeteorologica("Mar del Plata", -38.002, -57.556);
        añoInicial = 2020;
        cantidadAños = 4;
        rm = new RegistroTemperaturaMensual(añoInicial, cantidadAños, mdp);
        ...
        System.out.println(rm.getTopTemperatura());
